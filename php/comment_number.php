...
$sql_tm_count = "SELECT ProductName,comment_number FROM jd";
$sql_jd_count = "SELECT ProductName,comment_number FROM jd";
$sql_meilishuo_count = "SELECT ProductName,comment_number FROM meilishuo";
$sql_tb_count = "SELECT ProductName,comment_number FROM tb";
$sql_yihaodian_count = "SELECT ProductName,comment_number FROM yhd";
