...
$sql_jd_count = "SELECT productid,ProductName,Price from jd";
$sql_meilishuo_count = "SELECT productid,ProductName,Price from meilishuo";
$sql_tb_count = "SELECT productid,ProductName,Price from tb";
$sql_yihaodian_count = "SELECT productid,ProductName,Price from yhd";
$sql_tm_count = "SELECT productid,ProductName,Price from tm";
